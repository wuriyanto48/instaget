...
pub fn download_to_tx(url: &Url, out: Sender<Vec<u8>>, 
    ...
    loop {
        ...
        // send chunk
        // create buffer copy from the original buffer read from response
...
const BROWSERS: [&str; 58] = ["Firefox", "Safari", "Opera", "Flock", "Internet Explorer", "Seamonkey", "Tor Browser", "GNU IceCat", "CriOS", "TenFourFox",
...
const OPERATING_SYSTEMS: [&str; 114] = ["Windows 3.1", "Windows 95", "Windows 98", "Windows 2000", "Windows NT", "Linux 2.4.22-10mdk", "FreeBSD",
...
const LOCALS: [&str; 155] = ["cs-CZ", "en-US", "sk-SK", "pt-BR", "sq_AL", "sq", "ar_DZ", "ar_BH", "ar_EG", "ar_IQ", "ar_JO",
